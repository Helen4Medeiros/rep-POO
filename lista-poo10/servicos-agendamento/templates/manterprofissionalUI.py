...
class ManterProfissionalUI: 
    ...
    def inserir():
        ...
        if st.button("Inserir"):
            View.servico_inserir(nome, especialidade, conselho)
    ...
    def atualizar():
        ...
        if len(profissional) == 0: st.write("Nenhum profissional cadastrado")
            ...
            especialidade = st.text_input("Nova especialidade", op.get_esp())
            conselho = st.text_input("Novo conselho", op.get_cons())
